...
public class TelaCadCliente extends Principal{
	...
	private void botao(boolean band1,String  tela,int index) {
		...
		if(!tela.equals("Editar")) {
		    ...
		    cod.setText(""+index);
		    nome.setText(p.contConsultarCliente(index).getNome());
		    end.setText(p.contConsultarCliente(index).getEnd());
		    CPF.setText(p.contConsultarCliente(index).getCPF());
		    tel.setText(p.contConsultarCliente(index).getTelefone());
		...
		ed.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ControlCliente.conteditarClienteEdite(cliente);
